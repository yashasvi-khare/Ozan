                            ...
                            <div class="tab-pane fade active show" id="liton_tab_2_2">
                                <div class="ltn__product-tab-content-inner">
                                    <div class="row">
                                        <div class="col-lg-6 align-self-center">
                                            <div class="about-us-img-wrap about-img-left">
                                                <img src="{{asset('img/img-slide/11.jpg')}}" alt="Image">
                                                <div class="ltn__history-icon">
                            ...
                            <div class="tab-pane fade" id="liton_tab_2_3">
                                <div class="ltn__product-tab-content-inner">
                                    <div class="row">
                                        <div class="col-lg-6 align-self-center">
                                            <div class="about-us-img-wrap about-img-left">
                                                <img src="{{asset('img/img-slide/13.jpg')}}" alt="Image">
                                                <div class="ltn__history-icon">
                            ...
                            <div class="tab-pane fade" id="liton_tab_2_4">
                                <div class="ltn__product-tab-content-inner">
                                    <div class="row">
                                        <div class="col-lg-6 align-self-center">
                                            <div class="about-us-img-wrap about-img-left">
                                                <img src="{{asset('img/img-slide/12.jpg')}}" alt="Image">
                                                <div class="ltn__history-icon">
                                                    <i class="icon-award"></i>
                                                </div>
                                            </div>
                ...
                <div class="col-xl-4 col-sm-6 col-12">
                    <div class="ltn__feature-item ltn__feature-item-7 ltn__feature-item-7-color-white">
                        <div class="ltn__feature-icon-title">
                            ...
                            <h3><a href="{{route('service-details')}}">Maintenance Package</a></h3>
                        </div>
                        <div class="ltn__feature-info">
                            <p>Lorem ipsum dolor sit ame it, consectetur adipisicing elit, sed do eiusmod te mp or incididunt ut labore.</p>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="call-to-action-inner call-to-action-inner-5 text-decoration text-center">
                        <h2 class="white-color">24/7 Availability, Make <a href="{{route('contact.html')}}">An Appointment</a></h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row  ltn__blog-slider-one-active slick-arrow-1 ltn__blog-item-3-normal">
                ...
                <div class="col-lg-12">
                    <div class="ltn__blog-item ltn__blog-item-3">
                        <div class="ltn__blog-img">
                            <a href="{{route('blog-details')}}"><img src="{{asset('img/blog/1.jpg')}}" alt="#"></a>
                        </div>
                        <div class="ltn__blog-brief">
                            ...
                            <h3 class="ltn__blog-title"><a href="{{route('blog-details')}}">Common Engine Oil Problems and Solutions</a></h3>
                ...
                <div class="col-lg-12">
                    <div class="ltn__blog-item ltn__blog-item-3">
                        <div class="ltn__blog-img">
                            <a href="{{route('blog-details')}}"><img src="{{asset('img/blog/2.jpg')}}" alt="#"></a>
                        </div>
                        <div class="ltn__blog-brief">
                            <div class="ltn__blog-meta">
                                <ul>
                            ...
                            <h3 class="ltn__blog-title"><a href="{{route('blog-details')}}">How and when to replace brake rotors</a></h3>
                            <div class="ltn__blog-meta-btn">
                                <div class="ltn__blog-meta">
                                    <ul>
                                ...
                                <div class="ltn__blog-btn">
                                    <a href="{{route9'blog-details')}}">Read more</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="ltn__blog-item ltn__blog-item-3">
                        ...
                        <div class="ltn__blog-brief">
                            ...
                            <h3 class="ltn__blog-title"><a href="{{route('blog-details')}}">He for your First Track Day!</a></h3>
                            <div class="ltn__blog-meta-btn">
                                <div class="ltn__blog-meta">
                                    <ul>
                                        <li class="ltn__blog-date"><i class="far fa-calendar-alt"></i>June 24, 2020</li>
