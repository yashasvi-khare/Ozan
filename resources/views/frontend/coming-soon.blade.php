...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('Frontent/img/favicon.png')}}" type="image/x-icon" />
    <!-- Font Icons css -->
                ...
                <div class="col-lg-12">
                    <div class="coming-soon-inner">
                        ...
                        <div class="btn-wrapper mt-50">
                            <a href="{{route('contact')}}" class="btn theme-btn-2 btn-effect-2 text-uppercase">Contact Us</a>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Body main wrapper end -->
    ...
    <!-- All JS Plugins -->
    <script src="{{asset('Frontend/css/js/plugins.js')}}"></script>
    <!-- Main JS -->
    <script src="{{asset('Frontend/css/js/main.j')}}'"></script>
