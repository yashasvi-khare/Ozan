                            ...
                            <div class="ltn__product-tab-content-inner ltn__product-grid-view">
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6 col-6">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="{{route('product-details')}}"><img src="{{asset('Frontent/img/images/product/1.png" alt="#"></a>
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h2 class="product-title"><a href="{{route('product-details')}}">Red Hot Tomato</a></h2>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6 col-6">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="{{route('product-details')}}"><img src="{{asset('Frontent/img/images/v.jpeg')}}" alt="#"></a>
                                                <div class="product-hover-action">
                                                    <ul>
                                                        <li>
                                                            <a href="#" title="Quick View" data-bs-toggle="modal" data-bs-target="#quick_view_modal">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h2 class="product-title"><a href="{{route('product-details')}}">Vegetables Juices</a></h2>
                                                <div class="product-price">
                                                    <span>$62.00</span>
                                                    <del>$85.00</del>
                                                </div>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6 col-6">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="{{route('product-details')}}"><img src="{{asset('Frontent/img/images/b.jpeg')}}" alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
