                ...
                <div class="col-lg-4">
                    <aside class="sidebar-area ltn__right-sidebar">
                        ...
                        <div class="widget ltn__banner-widget">
                            <a href="{{route('shop')}}"><img src="{{asset('img/banner/banner-3.jpg')}}" alt="Banner Image"></a>
                        </div>
        ...
        <div class="container">
            ...
            <div class="row  ltn__blog-slider-one-active slick-arrow-1 ltn__blog-item-3-normal">
                ...
                <div class="col-lg-12">
                    <div class="ltn__blog-item ltn__blog-item-3">
                        <div class="ltn__blog-img">
                            <a href="{{route('blog-details')}}"><img src="img/blog/4.jpg" alt="#"></a>
                        </div>
                        <div class="ltn__blog-brief">
                            <div class="ltn__blog-meta">
                                <ul>
                ...
                <div class="col-lg-12">
                    <div class="ltn__blog-item ltn__blog-item-3">
                        ...
                        <div class="ltn__blog-brief">
                            ...
                            <h3 class="ltn__blog-title"><a href="{{route('blog-details')}}">How te Your Tires Last Longer</a></h3>
                            <div class="ltn__blog-meta-btn">
                                <div class="ltn__blog-meta">
                                    <ul>
                                        <li class="ltn__blog-date"><i class="far fa-calendar-alt"></i>June 24, 2020</li>
