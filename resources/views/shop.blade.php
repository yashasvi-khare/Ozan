...
@section('main-container')
    ...
    <div class="ltn__breadcrumb-area ltn__breadcrumb-area-3 ltn__breadcrumb-color-white bg-overlay-theme-black-90 bg-image plr--9---" data-bg="{{asset('img/bg/9.jpg')."?as"}}">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
